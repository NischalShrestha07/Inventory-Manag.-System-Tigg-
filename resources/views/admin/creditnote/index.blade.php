                ...
                <div class="col-12">
                    <div class="card">
                        <div class="menu-title navbar">
                            <h2 class="ml-2 menu-title">CREDIT NOTES</h2>
                            <div>
                                @if (session('success'))
                            ...
                            <div class="navbar d-flex justify-content-end">
                                <button type="button" data-toggle="modal" class="btn btn-success mr-3"
                                    data-target="#addNewCreditNote">Add New</button>
                            </div>
                        </div>

                        <div class="p-4">
                            <form method="GET" action="{{ route('creditnote.index') }}" class="mb-3">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="product" name="product">
                                            ...
                                            <option value="{{ $category->name }}" {{ request('name')==$category->
                                                id ?
                                                'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                        ...
                        <div class="modal" id="addNewCreditNote">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('AddNewCreditNote') }}" method="POST"
                                            ...
                                            <div class="modal" id="updateModel{{ $item->id }}">
                                                <div class="modal-dialogn modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('UpdateCreditNote') }}" method="POST"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
