                ...
                <div class="col-12">
                    <div class="card">
                        <div class="menu-title navbar">
                            <h2 class="ml-2 menu-title"><b>DEBIT NOTES</b></h2>
                            <div>
                                @if (session('success'))
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header btn-primary">
                                        <h4 class="modal-title"><b>Add New Debit Note</b></h4>
                                        ...
                                        <td class="font-weight-medium">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header bg-dark text-white">
                                                                    <h5 class="card-title mb-0">Debit Notes Information
                                                                    </h5>
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="row">
                                            ...
                                            <div class="modal" id="updateModel{{ $item->id }}">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header btn-primary">
                                                            <h4 class="modal-title"><b>Update Debit Note</b></h4>
