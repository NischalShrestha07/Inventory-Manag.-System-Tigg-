                ...
                <div class="col-12">
                    <div class="card">
                        <div class="menu-title navbar">
                            <h2 class="ml-2 menu-title">SUPPLIERS</h2>
                            <div>
                                @if (session('success'))
                            ...
                            <div class="navbar d-flex justify-content-end">
                                <button type="button" data-toggle="modal" class="btn btn-success mr-3"
                                    data-target="#addNewSupplier">Add New</button>
                            </div>
                        </div>

                        <div class="modal" id="addNewSupplier">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('AddNewSupplier') }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="name" name="name"
                                                    placeholder="Enter Supplier Name:" class="form-control mb-2">
                                            </div>
                                            <div class="mb-3">
                                                <label for="address">Address:</label>
                                                <input type="text" id="address" name="address"
                                                    placeholder="Enter Address:" class="form-control mb-2">
                                            </div>
                                            <div class="mb-3">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header bg-dark text-white">
                                                                    <h5 class="card-title mb-0">Supplier Information
                                                                    </h5>
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="row">
