                ...
                <div class="col-12">
                    <div class="card">
                        <div class="menu-title navbar">
                            <h2 class="ml-2 menu-title">Production Journal</h2>
                            <div>
                                @if (@session('success'))
                            ...
                            <div>
                                @if (@session('error'))
                                <div class="alert alert-error bg-error h3 text-white rounded fw-bolder fs-1">
                                    {{ session('error') }}
                                </div>
                                @endif
                            </div>
                            <div class="navbar d-flex justify-content-end">
                                <button type="button" data-toggle="modal" class="btn btn-success"
                                    data-target="#addNewJournal">Add New</button>
                            </div>
                        </div>


                        <div class="modal" id="addNewJournal">
                            <div class="modal-dialog">
                                <div class="modal-content">

                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">Add New Production Journal</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>

                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form action="{{ url('AddNewProductionJournal') }}" method="POST"
                                            ...
                                            <input type="integer" id="code" name="code" placeholder="Enter code:"
                                                class="form-control mb-2">
                                        ...
                                        <td class="font-weight-medium">
                                            ...
                                            <div class="modal" id="updateModel{{ $i }}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Update Production Journal</h4>
                                                            <button type="button" class="close"
                                                                data-dismiss="modal">&times;</button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="{{ url('UpdateJournal') }}" method="POST"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <input type="date" id="date" name="date"
                                                                    placeholder="Date:" value="{{ $item->date }}"
                                                                    class="form-control mb-2">
